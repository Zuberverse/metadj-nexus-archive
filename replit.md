...
- **Journal System**: Private journaling with markdown support, speech-to-text, and encrypted export/import. Includes a dedicated search bar to filter journal entries by title and content.
